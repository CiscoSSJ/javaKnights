...
public class ReinoHielo extends Reino {
	...
	/**
	 *Llama al constructor de la clase Reino pasando el nombre del rey,
	 *un arreglo de nombres de personajes importantes en el reino,
	 * el nombre del reino y el nivel.
	 */
	public ReinoHielo() {
	...
	/**
	 * Un método que representa la debilidad del reino de hielo.
	 * Si comprobar es verdadero, entonces el personaje pierde resistencia al desgaste.
	 */
	@Override
